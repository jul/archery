...
from .trait import InclusiveAdder, InclusiveSubber, ExclusiveMuler, Iterator, Searchable
...
class Hankyu(_Hankyu, dict):
    ...
    def copy(self):
        return deepcopy(bowyer(Hankyu, self))
...
class _Daikyu(LinearAlgebrae):
    ...
    def copy(self):
        return deepcopy(bowyer(Daikyu, self))
